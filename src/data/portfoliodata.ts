export const portfoliodata = [
  {
    ...
    projBackground:
      "Embark on a journey with Designo where exquisite design converges with strategic brilliance. This website presents an aura of user centric simplicity ensuring each visit transforms into a remarkable experience. Seamlessly transversing from the landing page to featured projects, this site is brought to life with a React frontend and an AWS backend. Crafted meticulously, this project exemplifies clean, maintainable patterns, with dynamic design alongside Apollo's GraphQL state management library. Immerse yourself and witness innovation. Venture to the user site or check out the technical intricacies on GitHub if that's more your feel. Your experience awaits.",
    images: {
      index: {
        desktop:
